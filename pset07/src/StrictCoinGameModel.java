...
public final class StrictCoinGameModel implements CoinGameModel {
   ...
   * @throws IllegalArgumentException {@code numPlayers} is less than or equal to 0
   *
   */
  ...
  public void addPlayer(int index){
    if(this.isGameOver()) {
      throw new IllegalArgumentException("cannot add played to finished game");
    }
    ...
    this.players.add(this.getPlayers()-1, index);
  }
